...
<body>
    ...
    <main id="main-content">
        ...
        <!-- Banner principal -->
       <?php View::componente('site/sections/banner');?>

        <!-- Benefícios da loja -->
       <?php View::componente('site/sections/beneficios');?>

        <!-- Categorias em destaque -->
       <?php View::componente('site/sections/categorias');?>

        <!-- Produtos em destaque -->
       <?php View::componente('site/sections/produtos');?>

        <!-- Banner de oferta -->
       <?php View::componente('site/sections/banneroferta');?>

        <!-- Produtos mais vendidos -->
       <?php View::componente('site/sections/produtosmais');?>

        <!-- Newsletter -->
       <?php View::componente('site/sections/newsletter');?>
