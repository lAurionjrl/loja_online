<section class="py-5" aria-labelledby="cat-heading">
            <div class="container">
                <div class="d-flex justify-content-between align-items-end mb-4">
                    <div>
                        <h2 id="cat-heading" class="h3 fw-bold mb-1">Categorias em Destaque</h2>
                        <p class="text-muted mb-0">Navegue pelos setores mais procurados da loja</p>
                    </div>
                        ...
                        <a href="categorias/?v=1" class="text-decoration-none text-dark">
                            <div class="card h-100 card-hover category-card text-center border-0 shadow-sm">
                                ...
                                <div class="card-body p-2 p-md-3">
                                    ...
                                    <p class="card-text text-muted small mb-0">Notebooks e PCs</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="categorias/?v=2" class="text-decoration-none text-dark">
                            <div class="card h-100 card-hover category-card text-center border-0 shadow-sm">
                                ...
                                <div class="card-body p-2 p-md-3">
                                    ...
                                    <p class="card-text text-muted small mb-0">Smartphones</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="categorias/?v=3" class="text-decoration-none text-dark">
                            <div class="card h-100 card-hover category-card text-center border-0 shadow-sm">
                                ...
                                <div class="card-body p-2 p-md-3">
                                    ...
                                    <p class="card-text text-muted small mb-0">Periféricos e mais</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="categorias/?v=3" class="text-decoration-none text-dark">
                            <div class="card h-100 card-hover category-card text-center border-0 shadow-sm">
                                ...
                                <div class="card-body p-2 p-md-3">
                                    ...
                                    <p class="card-text text-muted small mb-0">Fones e caixas</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="categorias/?v=4" class="text-decoration-none text-dark">
                            <div class="card h-100 card-hover category-card text-center border-0 shadow-sm">
                                ...
                                <div class="card-body p-2 p-md-3">
                                    ...
                                    <p class="card-text text-muted small mb-0">Casa inteligente</p>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="categorias/?v=3" class="text-decoration-none text-dark">
                            <div class="card h-100 card-hover category-card text-center border-0 shadow-sm">
                                ...
                                <div class="card-body p-2 p-md-3">
                                    ...
                                    <p class="card-text text-muted small mb-0">Consoles e jogos</p>
                                </div>
                            </div>
                        </a>
                    </div>
